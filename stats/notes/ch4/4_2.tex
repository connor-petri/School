...
CHECK THIS IT IS NOT ACCURATE
\paragraph*{a.}
\begin{align*}
    E(X) &= \int_{-\infty}^{\infty} x f(x) dx \\
    &= \int_0^2 x \cdot \frac{3}{8} x dx + \int_{-\infty}^0 x \cdot 0 dx + \int_2^{\infty} x \cdot 0 dx \\
    &= \int_0^2 \frac{3}{8} x^3 dx + 0 + 0 \\
    &= \frac{3}{8} \left[ \frac{x^4}{4} \right]_0^2 \\
    &= \frac{3}{8} \cdot \frac{16}{4} = 1.5
\end{align*}

\paragraph*{b.}
\begin{align*}
    E(X^2) &= \int_{-\infty}^{\infty} x^2 f(x) dx \\
    &= \int_0^2 x^2 \cdot \frac{3}{8} x dx + \int_{-\infty}^0 x^2 \cdot 0 dx + \int_2^{\infty} x^2 \cdot 0 dx \\
    &= \int_0^2 \frac{3}{8} x^3 dx + 0 + 0 \\
    &= \frac{3}{8} \left[ \frac{x^4}{4} \right]_0^2 \\
    &= \frac{3}{8} \cdot \frac{16}{4} = 1.5
\end{align*}
