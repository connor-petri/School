...
//class StudentDQI {
//private:
//    ExtendableArray<Student>* soa;  // Allocated Extended Student Array
...
void classTest()
{
    string infileName = "../test.txt"; // Use if Input redirected
    ...
    Deque<Student>* dqi = nullptr;   // Pointer to DeQue
    ...
    dqi = new Deque<Student>(ssize);  // Create Dequeue of specified size.
